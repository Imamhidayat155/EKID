	  ...
	  <div id="login-page">
	  	<div class="container">	  	
			<h1 align="center" style="color:red">UNIFORM REQUESTION SYSTEM</h1>
							...
							<?php }else{} ?>
    		  <form class="form-login" method="post" action="<?php echo $this->config->item('link_url')?>login/aksi_login">
		        ...
		        <div class="login-wrap">
		            <input name="username" id="username" type="input" class="form-control" autocomplete="off" placeholder="User Nama" required  autofocus>
                    <br />
