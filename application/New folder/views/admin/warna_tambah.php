          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('admin/insert_warna');?>
                   <div class="form-group">
                    <label for="exampleInputEmail1">KODE</label>
                      <input type="text" readonly class="form-control" name="warna_kode" value="<?php echo $autonumb?>"/>
                  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                    <label for="exampleInputEmail1">WARNA</label>
                      <input type="text" class="form-control" name="warna_nama" placeholder=""/>
                  </div>
