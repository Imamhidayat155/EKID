...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
	...
	<?php if($this->session->userdata('akses')=='Super User'){?>	
      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>MASTER_USER</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()?>admin/user"><i class="fa fa-user"></i>DATA_USER</a></li>
            <li class="active"><a href="<?php echo base_url()?>admin/karyawan"><i class="fa fa-group"></i>DATA_KARYAWAN</a></li>
          </ul>
        </li>
      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>MASTER_DATA</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url()?>admin/size"><i class="fa fa-suitcase"></i>DATA_SIZE</a></li>
            <li class="active"><a href="<?php echo base_url()?>admin/warna"><i class="fa fa-suitcase"></i>DATE_WARNA</a></li>
            <li class="active"><a href="<?php echo base_url()?>admin/item"><i class="fa fa-group"></i>DATA_ITEM</a></li>
          </ul>
        </li>
  <?php } if($this->session->userdata('akses')=='Admin' || $this->session->userdata('akses')=='Super User'){?>	
		<li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="#" onclick="javascript: return confirm('Admin tidak bisa melakukan Transaksi')"><i class="fa fa-plus"></i>FORM_REQUISITION</a></li>
            <li class="active"><a href="<?php echo base_url()?>admin/transaksi"><i class="fa fa-navicon"></i>DETAIL_REQUISITION</a></li>
