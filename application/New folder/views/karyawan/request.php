        ...
        <section class="content">
          	...
          	<div class="col-xs-12">
                ...
                <div class="box-header">
                  <h3 class="box-title">
                    Data yang muncul adalah data yang sudah selesai transaksi
                  ...
                  <table id="example1" class="table table-bordered table-hover dataTable">
                    ...
                    <tbody>
                        ...
                        <td><?php echo $no++ ?></td>
							...
							<td><?php echo $lihat->req_total?></td>
							<td><?php echo $lihat->size_no?></td>
							<td><?php echo $lihat->req_tanggal?></td>
                        <td align="center">
                          <div class="btn-group" role="group">
                            <a href="#" onclick="window.open('<?php echo base_url(); ?>laporan/cetak_request/<?php echo $lihat->reqhed_code?>')" class="btn btn-sm btn-info btn-flat"><i class="fa fa-print"></i> Print</a>
                          </div>
                        </td>                  		
                    	</tr>
                    	<?php endforeach; ?>
