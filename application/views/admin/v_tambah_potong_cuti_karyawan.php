...
<section class="content">
  <div class="box box-info">
    ...
    <div class="box-body">
      <!-- form start -->
      <?php echo form_open('admin/insert_potong_cuti_karyawan_multiple');?>
      <div class="form-group">
        ...
        <select class="form-control select2" multiple="multiple" multiple name="kar_id[]">
                      ...
                      foreach($sql as $col){
                          echo "<option value='$col->kar_id'>$col->kar_nik | $col->kar_nama</option>";
                      }
                      ?>
                    </select>
      </div>
...
function getCutiCode()
{
  document.getElementById('pc_kode').placeholder='Loading...';
	...
	$.ajax({
		type	:"POST",
		url		:"<?php echo base_url()?>admin/getCutiCode/"+kar_id+"/"+cuti_kode,
