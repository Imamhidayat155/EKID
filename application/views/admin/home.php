...
<section class="content">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="inner">
            ...
            <a href="<?php echo base_url('admin/history_pengambilan_cuti/'.$this->session->userdata('id'))?>" class="small-box-footer">Lihat History Cuti <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <div class="small-box bg-green">
            ...
            <div class="inner">
                <h3>
                    <?php if(isset($jml_CT_sisa2)) echo $jml_CT_sisa2 -4; else echo 0; ?> <!-- Dikurangi 4 untuk CB saat lebaran tahun 2021  -->
                </h3>
                <h4>Sisa CT</h4>
            </div>
