            ...
            <div class="box">
                ...
                <div class="col-md-12">
                    <fieldset class="scheduler-border">
                        ...
                        <form id="form_filter" method="post" action="<?php echo base_url('admin/filter_report_cuti_daily'); ?>">
...
window.open('<?php echo base_url()?>admin/export_daily/'+a+'/'+b); //send var a & b as param to export_daily function
}
</script>
