...
<div class="row">
    ...
    <div class="box-header">
        <a href="<?php echo base_url('admin/upload_jatah_cuti_panjang'); ?>"  class="btn btn-md btn-warning btn-flat"><i class="fa fa-upload"></i> UPLOAD</a>
    ...
    <form method="post" action="<?php echo base_url('admin/simpan_cuti_tahunan_multiple')?>">
        ...
        <h4><b>Silahkan Isi jumlah cuti panjang yang akan ditambahkan</b></h4>
        <table id="example" class="table table-bordered table-hover dataTable"> <br>
            <thead>
            <tr>
                <th>NO</th>
                <th>PIN_KARYAWAN</th>
            ...
            foreach ($data as $lihat) :
                ...
                if($jumlah > 10) $jumlah = 10; //nilai maksimal jatah cuti
            ?>
                <tr>
                    <td><?php echo $no++ ?></td>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="cuti_id" value="2">
