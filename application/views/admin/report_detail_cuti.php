            ...
            <div class="box">
                ...
                <div class="col-md-12">
								<fieldset class="scheduler-border">
									<legend class="scheduler-border">Filter By Tanggal Approved / Ditolak</legend>						
									<form id="form_filter" method="post" action="<?php echo base_url('admin/filter_report_detail_cuti_all'); ?>">
...
window.open('<?php echo base_url()?>admin/export_detail/'+a+'/'+b); //send var a & b as param to export_daily function
}
</script>
