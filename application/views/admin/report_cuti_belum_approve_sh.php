            ...
            <div class="box">
                ...
                <div class="col-md-12">
								<fieldset class="scheduler-border">
									...
									<form id="form_filter" method="post" action="<?php echo base_url('admin/filter_report_cuti_belum_approve_sh'); ?>">
...
window.open('<?php echo base_url()?>admin/export_cuti_belum_approve_sh/'+a+'/'+b);
}
</script>
