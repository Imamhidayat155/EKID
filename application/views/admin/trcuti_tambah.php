...
<section class="content">
  <div class="box box-info">
    ...
    <div class="box-body">
      <!-- form start -->
      <?php echo form_open('admin/insert_trcuti');?>

      
      
      <div class="form-group">
        <label for="exampleInputEmail1">NAMA KARYAWAN</label>
        <select name="kar_id" class="form-control select2" id="kar_id">
            <?php
      ...
      <div class="form-group">
        ...
        <select name="cuti_kode" class="form-control select2" id="cuti_kode" onchange="getCutiCode()" required>
      ...
      <div class="form-group">
        ...
        <input type="text" readonly class="form-control" name="pc_kode" id="pc_kode"/>
