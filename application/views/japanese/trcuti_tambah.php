...
<section class="content">
  <div class="box box-info">
    ...
    <div class="box-body">
      <!-- form start -->
      <?php echo form_open('japanese/insert_trcuti');?>
      ...
      <div class="form-group">
        ...
        <select name="cuti_kode" onchange="getCutiCode()" class="form-control select2" id="cuti_kode">
      ...
      <div class="form-group">
        ...
        <div class="input-group date">
          ...
          <input type="text" style="width:50%" class="form-control" id="startdate" name="pc_tanggalfrom" required/>
        </div>
      </div>
      ...
      <a href="<?php echo base_url('japanese'); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
