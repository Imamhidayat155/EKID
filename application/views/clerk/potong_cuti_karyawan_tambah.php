  ...
  <div class="box box-info">
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        <label for="exampleInputEmail1">KODE CUTI  (Muncul setelah pilih karyawan)</label>
      ...
      <div class="form-group">
        ...
        <select name="cuti_kode" class="form-control select2">
            <?php
...
{
	var a=document.getElementById('kar_id').value; //alert(a)
	$.ajax({
		type	:"POST",
		url		:"<?php echo base_url()?>clerk/getCutiCode/"+a,
