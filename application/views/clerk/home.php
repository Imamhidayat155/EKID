      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url()?>admin/karyawan" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <h4>APPROVAL REQUESTION</h4>
            </div>
            <div class="icon">
              <i class="fa fa-shopping-cart"></i>
            </div>
            <a href="<?php echo base_url()?>leader_up/approval" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
            ...
            <div class="box-body">
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" align="center">
                  ...
                  <div class="item">
                      <img src="<?php echo $this->config->item('link_url')?>assets/foto/foto4.png" alt="Fourth slide">
