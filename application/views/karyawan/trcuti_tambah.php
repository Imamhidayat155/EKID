...
<section class="content">
  <div class="box box-info">
    <div class="box-header with-border">
      <h2 class="box-title"><b>FORM PERMOHONAN CUTI</b></h2>
    </div>
    <div class="box-body">
      <!-- form start -->
      <?php echo form_open('karyawan/insert_trcuti');?>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="pc_grup_line" placeholder="Contoh: Casting A" required autocomplete='off'/>
      </div>
      <div class="form-group">
        <label for="exampleInputEmail1">JENIS CUTI</label>
        <select name="cuti_kode" onchange="getCutiCode()" id="cuti_kode" class="form-control select2" required>
      ...
      <div class="form-group">
        <label for="exampleInputEmail1">KODE CUTI (Muncul setelah pilih Jenis cuti)</label>
        <input type="text" class="form-control" name="pc_kode" id="pc_kode" readonly required" />
...
function getCutiCode()
{
  document.getElementById('pc_kode').placeholder='Loading...';
	...
	var kar_id=document.getElementById('kar_id').value;
	var cuti_kode=document.getElementById('cuti_kode').value; 
