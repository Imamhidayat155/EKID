                    ...
                    <table id="example2" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="label label-warning"><b style="color: white;"><?php if($lihat->status == 1){echo "Menunggu Konfirmasi";} ?></b></span></td>
                                <td align="center">
                                    <div class="btn btn-default" role="group">
                                        <a href="<?php echo base_url(); ?>karyawan/edit_izin_keluar/<?php echo $lihat->id ?>"
                                            class="btn btn-sm btn-primary "><i class="fa fa-edit"></i> Edit</a>

                                        <a href="<?php echo base_url(); ?>karyawan/hapus_izin_keluar/<?php echo $lihat->id ?>"
