        ...
        <nav class="navbar navbar-static-top">
          ...
          <div class="navbar-custom-menu">
            ...
            <li class="dropdown messages-menu">
                <a href="<?php echo base_url('karyawan/detail_rekap_cuti_karyawan/'.$this->session->userdata('id')); ?>" class="" data-toggle="">
                  <i class="fa fa-envelope-o"></i>
                  <span class="label label-success"><?php echo $jml_cuti_approved; ?></span>
                </a>
              </li>
            <li class="dropdown messages-menu">
                <a href="<?php echo base_url('karyawan/tr_cuti') ?>" class="" data-toggle="">
                  <i class="fa fa-flag-o"></i>
                  <span class="label label-warning"><?php echo $jml_cuti_wait_approve_leader; ?></span>
                </a>
              </li>
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p><small><a href="<?php echo base_url() ?>karyawan/ganti_foto/<?php echo $this->session->userdata('id') ?>" style="color:white">Ganti Foto</a></small></p>
                  </li>
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url() ?>karyawan/profile" class="btn btn-default btn-flat">Profile</a>
                    </div>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              ...
              <?php 
                    $id=$this->session->userdata('id'); //id karyawan dari session
              ...
              <?php }else{?>
                <li>
                  <a href="<?php echo base_url('karyawan/tambah_trcuti/'.$this->session->userdata('id'))?>">
                    <i class="fa fa-pencil-square" style="color: yellow;"></i> <span style="color: yellow;">PERMOHONAN CUTI</span>
                  </a>
                  <!-- <a href="#" onclick="return confirm('Cuti Tahun 2022 belum bisa dipakai, sedang proses closing cuti 2021 !')">
                    <i class="fa fa-pencil-square" style="color: yellow;"></i> <span style="color: yellow;">PERMOHONAN CUTI</span>
            ...
            <li>
              <a href="<?php echo base_url('karyawan/tambah_izin_keluar')?>">
                <i class="fa fa-pencil-square" style="color: yellow;"></i> <span style="color: yellow;">IZIN KELUAR</span>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-folder-open" "></i> <span >STATUS</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo base_url() ?>karyawan/tr_cuti"><i class="fa fa-check-circle"></i>Cuti</a></li>
                <li class="active"><a href="<?php echo base_url() ?>karyawan/status_izin_keluar"><i class="fa fa-check-circle"></i>Izin Keluar</a></li>
              </ul>
            </li>
            <hr style="height:1px; margin-top: 5px; margin-bottom: 5px; border-top: 3px double #8c8c8c;">

            <li>
              <a href="<?php echo base_url('karyawan/detail_rekap_cuti_karyawan/'.$this->session->userdata('id')) ?>">
            ...
            <li>
              <a href="<?php echo base_url('karyawan/rekap_cuti_karyawan') ?>">
                <i class="fa fa-folder-open" style="color: Aqua;"></i> <span>REKAP CUTI KARYAWAN</span>
              </a>
            </li>
            <li>
              <a href="#" onclick="return confirm('Please contact IT Section to turn on this menu')">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="<?php echo base_url('karyawan/report_cuti_belum_approve_leader') ?>"><i class="fa fa-user"></i>Cuti Belum Approve Leader</a></li>
                </ul>
                <ul class="treeview-menu">
                  <li class="active"><a href="<?php echo base_url('karyawan/report_cuti_belum_approve_sh') ?>"><i class="fa fa-user"></i>Cuti Belum Approve SH</a></li>
                </ul>
                <ul class="treeview-menu">
                  <li class="active"><a href="<?php echo base_url('karyawan/report_cuti_belum_approve_js') ?>"><i class="fa fa-user"></i>Cuti Belum Approve Japan Staff</a></li>
                </ul>
                <ul class="treeview-menu">
                  <li class="active"><a href="<?php echo base_url('karyawan/report_cuti_daily') ?>"><i class="fa fa-user"></i>Report Cuti Daily</a></li>
                </ul>
              </li>
            <!-- ------------------------------Aktifkan script dibawah jika ada request potong cuti karyawan dari Admin------------------------------ -->

            <!-- <li>
              <a href="<?php echo base_url('karyawan/tambah_potong_cuti_karyawan') ?>">
                <i class="fa fa-exclamation" style="color: red;"></i> <span>CREATE CUTI MASSAL</span>
              </a>
            </li>
            <li>
              <a href="<?php echo base_url('karyawan/status_cuti_massal') ?>">
                <i class="fa fa-exclamation" style="color: red;"></i> <span>STATUS CUTI MASSAL</span>
              </a>
            </li> -->
            ...
            <li>
              <a href="<?php echo base_url('karyawan/ganti_password/'. $this->session->userdata('id'))?>">
