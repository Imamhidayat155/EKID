...
<section class="content">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="inner">
            ...
            <a href="<?php echo base_url('manager/history_pengambilan_cuti/'.$this->session->userdata('id'))?>" class="small-box-footer">Lihat History Cuti <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-lg-3 col-xs-6">
        <!-- small box -->
