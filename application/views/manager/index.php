  ...
  <body class="hold-transition skin-green sidebar-mini">
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          ...
          <div class="navbar-custom-menu">
            ...
            <li class="dropdown messages-menu">
                <a href="<?php echo base_url('manager/approval') ?>" class="" data-toggle="">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p><small><a href="<?php echo base_url() ?>manager/ganti_foto/<?php echo $this->session->userdata('id') ?>" style="color:white">Ganti Foto</a></small></p>
                  </li>
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url() ?>manager/profile" class="btn btn-default btn-flat">Profile</a>
                    </div>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <?php } ?>
            <!-- AKTIFKAN MENU D BAWAH JIKA INGIN PAKAI CUTI BERSAMA -->
            <!-- <li>
              <a href="<?php echo base_url('manager/tambah_trcuti/'.$this->session->userdata('id')) ?>">
                <i class="fa fa-home" style="color: yellow;"></i> <span style="color: yellow;">PERMOHONAN CUTI</span>
              </a>
            ...
            <li>
              <a href="<?php echo base_url('manager/tambah_izin_keluar')?>">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo base_url() ?>manager/tr_cuti"><i class="fa fa-check-circle"></i>Cuti</a></li>
                <li class="active"><a href="<?php echo base_url() ?>manager/status_izin_keluar"><i class="fa fa-check-circle"></i>Izin Keluar</a></li>
              </ul>
            </li>
            <li>
              <a href="<?php echo base_url('manager/detail_rekap_cuti_karyawan/'.$this->session->userdata('id')) ?>">
            ...
            <hr style="height:1px; margin-top: 5px; margin-bottom: 5px; border-top: 3px double #8c8c8c;">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="<?php echo base_url() ?>manager/approval"><i class="fa fa-check-circle"></i>Cuti</a></li>
                  <li class="active"><a href="<?php echo base_url() ?>manager/izin_keluar"><i class="fa fa-check-circle"></i>Izin Keluar</a></li>
                  <li class="active"><a href="<?php echo base_url() ?>manager/history_approval"><i class="fa fa-archive"></i>History Approval</a></li>
                </ul>
              </li>
              <li>
                <a href="<?php echo base_url('manager/report_cuti_daily') ?>">
                  <i class="fa fa-user" style="color: orange;"></i> <span style="color: orange;">REKAP CUTI KARYAWAN</span>
                </a>
              </li>
              <hr style="height:1px; margin-top: 5px; margin-bottom: 5px; border-top: 3px double #8c8c8c;">
              <li>
                <a href="<?php echo base_url('manager/ganti_password/'. $this->session->userdata('id'))?>">
      ...
      <div class="content-wrapper">
        ...
        <?php $this->load->view('manager/' . $page); ?>
    ...
    <script>
      ...
      $('.tombol-info-cuti-tahun-lalu').on('click',function (e){
        ...
        Swal.fire({
        title: 'INFO !',
        text: "Untuk Sisa Cuti Tahun lalu actual nya sudah d tambahkan ke Cuti Tahunan.",
        icon: 'warning',
        // showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
      ...
      $('.tombol-approve-izin-keluar').on('click',function (e){
        e.preventDefault();
        const href = $(this).attr('href'); //Ambil atrribut href pada tombol hapus yg sedang d click

        Swal.fire({
        title: 'Apakah anda yakin',
        text: "Approve data izin keluar ini ?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: 'Approve Izin Keluar !'
        }).then((result) => {
        if (result.value) {
            document.location.href = href; //Jalankan variabel href dengan document.location.href
        }
