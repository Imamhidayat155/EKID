          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <form action="<?php echo base_url()?>manager/update_fotoprofile/<?php echo $data->kar_id?>" method="post" enctype="multipart/form-data">
                  ...
                  <a href="<?php echo base_url(); ?>manager/user" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
