        ...
        <p>
            <?php 
                ...
                if(isset($kar_id)){
                    ...
                    FROM tr_permohonan_cuti WHERE kar_id=$kar_id
            ...
            <span style="">
                <span style="font-size: 16px; font-wieght: bold;"><br>
                    ...
                    <strong>GROUP             : <?php echo $sql2->row()->pc_grup_line; ?></strong>
                </span>
            </span>
        </p>
        <p style="">
            ...
            <p style="">
                <span style="">
                    ...
                    <span style="font-size: 16px;"><strong>"Untuk Japan Staff terkait silahkan lakukan <u>Approve atau Reject Cuti</u>, </strong>dengan klik link berikut : </span>
            ...
            <!-- <p style="">
                <span style="">
                    <span style="font-size: 16px;">Apabila memiliki pertanyaan, silakan hubungi IT Section Ext: 120/121
                    </span>
                </span>
            </p> -->
        </p>
