...
<html lang="en">
    ...
    <style>
        .css-selector {
            background: linear-gradient(272deg, #004cff, #d400ff);
                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <form method="post" action="<?php echo base_url('login/aksi_login_admin')?>">
                                            ...
                                            <div class="input-group input-group-joined mb-3">
                                                <input class="form-control form-control-solid" type="text" name="username" value="<?=$username?>" placeholder="Handpunch PIN" aria-label="Email Address" aria-describedby="emailExample" />
                                            </div>
                    ...
                    <div class="container-xl px-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-md-end small">
                                ...
                                &middot;
                                <a href="#!" onclick="return alert('Silahkan hubungi IT Section')">Terms &amp; Conditions</a>
                            </div>
                        </div>
                    </div>
                </footer>
