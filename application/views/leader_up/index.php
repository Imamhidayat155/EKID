  ...
  <body class="hold-transition skin-purple sidebar-mini">
    <div class="wrapper">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              <li class="dropdown messages-menu">
                <a href="<?php echo base_url('leader_up/approval') ?>" class="" data-toggle="">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p><small><a href="<?php echo base_url() ?>leader_up/ganti_foto/<?php echo $this->session->userdata('id') ?>" style="color:white">Ganti Foto</a></small></p>
                  </li>
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url() ?>leader_up/profile" class="btn btn-default btn-flat">Profile</a>
                    </div>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="<?php echo base_url() ?>leader_up">
            ...
            <?php 
              ...
              <?php }else{?>      
                <li>
                  <a href="<?php echo base_url('leader_up/tambah_trcuti/'.$this->session->userdata('id')) ?>">
            ...
            <li>
              <a href="<?php echo base_url('leader_up/tambah_izin_keluar')?>">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo base_url() ?>leader_up/tr_cuti"><i class="fa fa-check-circle"></i>Cuti</a></li>
                <li class="active"><a href="<?php echo base_url() ?>leader_up/status_izin_keluar"><i class="fa fa-check-circle"></i>Izin Keluar</a></li>
              </ul>
            </li>
            <li>
            <a href="<?php echo base_url('leader_up/detail_rekap_cuti_karyawan/'.$this->session->userdata('id')) ?>">
            ...
            <hr style="height:1px; margin-top: 5px; margin-bottom: 5px; border-top: 3px double #8c8c8c;">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="<?php echo base_url() ?>leader_up/approval"><i class="fa fa-check-circle"></i>Approval Cuti</a></li>
                  <li class="active"><a href="<?php echo base_url() ?>leader_up/history_approval"><i class="fa fa-archive"></i>History Approval</a></li>
                </ul>
              </li>
              <li>
                <a href="<?php echo base_url('leader_up/rekap_sisa_cuti') ?>">
                  <i class="fa fa-user"></i> <span>REKAP CUTI KARYAWAN</span>
                </a>
              </li>
              <hr style="height:1px; margin-top: 5px; margin-bottom: 5px; border-top: 3px double #8c8c8c;">
              <li>
                <a href="<?php echo base_url('leader_up/ganti_password/'. $this->session->userdata('id'))?>">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url() ?>leader_up"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"><?php echo $title ?></li>
          </ol>
        </section>

        <?php $this->load->view('leader_up/' . $page); ?>
    ...
    <script>
      ...
      $('.tombol-approve').on('click',function (e){
        e.preventDefault();
        const href = $(this).attr('href'); //Ambil atrribut href pada tombol  yg sedang d click
