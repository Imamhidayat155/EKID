                    ...
                    <table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo date("d-m-Y", strtotime($lihat->pc_tanggalfrom))?></td>
                                <td><?php echo date("d-m-Y", strtotime($lihat->pc_tanggalto))?></td>
...
<script>
    ...
    function get_id(id){
        $('#pc_id').val(id); //Ambil parameter pc_id saat button reject pertama ditekan, lalu set pc_id ke textarea (#pc_id)
    }
        ...
        $(document).on('click', '#btn_reject', function (){
            ...
            $.ajax({
                ...
                success :function(data){ //alert(data)
                    ...
                    location.reload("leader_up/approval");
                }
            });
        });
