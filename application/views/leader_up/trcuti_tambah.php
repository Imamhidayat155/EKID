...
<section class="content">
  <div class="box box-info">
    ...
    <div class="box-body">
      <!-- form start -->
      <?php echo form_open('leader_up/insert_trcuti');?>
      ...
      <!-- <div class="form-group">
        ...
        <input type="text" class="form-control" name="pc_grup_line" placeholder="Contoh: Casting A" required />
      </div> -->
      <div class="form-group">
      ...
      <a href="<?php echo base_url('leader_up'); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
...
function getCutiCode()
{
  document.getElementById('pc_kode').placeholder='Loading...';
	...
	$.ajax({
		type	:"POST",
		url		:"<?php echo base_url()?>leader_up/getCutiCode/"+kar_id+"/"+cuti_kode,
