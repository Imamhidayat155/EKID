...
.tabelfooter {
	...
	<body onload="window.print();" onafterprint="window.close();" >
				...
				<title><?php echo $title?></title>
					<fieldset>
						<legend style="color: orange;"><h2 align="center">Detail Histori CP</h2></legend>
						<?php  
					...
					<table border="1" class="tabel" cellpadding="5" width="100%" style="border-collapse:collapse" >
						...
						<?php //relasi detail dengan karyawan
							...
							$this->db->join('v_jatah_CP_perkaryawan c', 'c.kar_id=a.kar_id','left');
							$this->db->join('v_potong_CP_perkaryawan d', 'd.kar_id=a.kar_id','left');
							$this->db->where('a.kar_id=',$id);
							$this->db->where('a.cuti_kode=','CP');
							$this->db->where('a.cuti_kode=','CP');
